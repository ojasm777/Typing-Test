  ...
  return (
    <div className="header">
      <div className="logo" onClick={handleClick}>
        <div class="logo-svg">
          {/* <img src="/keyboard.svg" alt="logo" height={"50px"} width={"auto"} style={{stroke: theme.buttonColor}}/> */}
          <svg
            viewBox="0 0 24 24"
            fill="none"
            height={"50px"}
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              ></path>
              <path
                style={{ stroke: theme.buttonColor }}
        ...
        <h1 class="logo-title">TypoTest</h1>
      </div>
      <div class="user-icon">
        {/* user icon here */}
        <AccountCircle />
